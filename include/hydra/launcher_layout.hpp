...
struct LauncherTextMeasurements {
    ...
    int sectionLabelHeight{0};
    int playerLabelWidth{0};
    int playerLabelHeight{0};
    int playerStatusWidth{0};
    int playerStatusHeight{0};
    int configureWidth{0};
    int configureHeight{0};
    int refreshWidth{0};
    int refreshHeight{0};
    int addExecutableWidth{0};
    int addExecutableHeight{0};
    int playWidth{0};
    int playHeight{0};
    int addPlayerWidth{0};
    int addPlayerHeight{0};
...
struct LauncherTextRequirements {
    ...
    int sectionLabelMinimumHeight{0};
    int playerLabelMinimumWidth{0};
    int playerLabelMinimumHeight{0};
    int playerStatusMinimumWidth{0};
    int playerStatusMinimumHeight{0};
    int configureMinimumWidth{0};
    int configureMinimumHeight{0};
    int refreshMinimumWidth{0};
    int refreshMinimumHeight{0};
    int addExecutableMinimumWidth{0};
    int addExecutableMinimumHeight{0};
    int playMinimumWidth{0};
    int playMinimumHeight{0};
    int addPlayerMinimumWidth{0};
    int addPlayerMinimumHeight{0};
