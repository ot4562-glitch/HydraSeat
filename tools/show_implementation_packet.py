...
def configure_console_output() -> None:
    """Avoid Windows legacy-codepage crashes when roadmap text contains Unicode."""
    for stream in (sys.stdout, sys.stderr):
        ...
        try:
            ...
            # Output encoding is diagnostic presentation only; roadmap validation
            # must still run even when the embedding host owns the stream wrapper.
            pass
