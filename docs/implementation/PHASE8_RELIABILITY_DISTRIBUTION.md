...
- Windows/MSVC x64/x86 CI is still required before `VALIDATED`. This packet does not wire Gate C processes into the watchdog, execute recovery actions from journal data, or replace the emergency reset CLI; those remain `P3-REC-01` and `P8-RESET-01` responsibilities.
