...
- [ ] Durable crash journal/safe-mode marker is `CODE_COMPLETE` locally (`P8-JOURNAL-01`; Windows x64/x86 CI pending); Gate C watchdog/crash rollback acceptance remains `P3-REC-01`
